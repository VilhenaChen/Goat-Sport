...
import { ListPlayersPresentation, PlayerDetailsPresentation } from "./PlayerDetailsPresentation";
...
export const PlayersDetailsContainer = memo(() => {
  ...
  return (
    <PlayerDetailsPresentation handlePlayerEdit={handlePlayerEdit} player={player} handlePlayerDelete={handlePlayerDelete}
